...
public class XpathByAttributesTextPractice02 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//div[text()='Maharaja Veg Biryani']")).click();
		Thread.sleep(2000);
 
		WebElement deliveryCharges = driver.findElement(By.xpath("//div[@class=\"sc-aXZVg kVQudY\"']"));
